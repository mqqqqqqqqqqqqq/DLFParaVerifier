...
if __name__ == "__main__":
    ...
    # parse_name = "protocols/germanNoData/german_withoutData"
    ...
    # print(check_invariants(protocol_name, "!(Sta.Dir.InvSet[1] = TRUE & Sta.Dir.Pending = FALSE & Sta.Proc[2].CacheState = CACHE_E)")) 
    ...
    set_bmc(protocol_name+"_node3", smv_content)

    print(is_inv_bmc(protocol_name+"_node3", "!(Sta.Dir.InvSet[1] = TRUE & Sta.Dir.Pending = FALSE & Sta.Proc[2].CacheState = cache_e)"))
